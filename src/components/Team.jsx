               ...
               <div className="flex flex-col items-center shadow-2xl text-start rounded-2xl">
                  <div
                     ...
                     <div className="absolute bottom-4 left-4">
                        ...
                        <h6 className="text-base text-white">Master Pickler</h6>
                     </div>
                  </div>
               </div>
               <div className="flex flex-col items-center shadow-2xl text-start rounded-2xl">
                  <div
                     ...
                     <div className="absolute bottom-4 left-4">
                        ...
                        <h6 className="text-base text-white">Assistant pickler</h6>
                     </div>
                  </div>
               </div>
               <div className="flex flex-col items-center shadow-2xl text-start rounded-2xl">
                  <div
                     ...
                     <div className="absolute bottom-4 left-4">
                        ...
                        <h6 className="text-base text-white">Tangy Guru</h6>
                     </div>
                  </div>
               </div>
            </div>
